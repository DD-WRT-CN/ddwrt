...
php7: libxml2 libmcrypt icu glib20 zlib libzip openssl sqlite php7-configure
	CC="ccache $(ARCH)-linux-uclibc-gcc" \
...
PHP_CONFIGURE_ARGS= \
	...
	LIBXML_CFLAGS="$(TOP)/libxml2/include" \
	LIBXML_LIBS="$(TOP)/libxml2/.libs" \
	CURL_CFLAGS="$(TOP)/curl/include" \
	CURL_LIBS="$(TOP)/curl/lib/.libs" \
